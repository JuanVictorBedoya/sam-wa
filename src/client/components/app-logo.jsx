		...
		return (
			<svg width="75mm" height="75mm" enable-background="new" version="1.1" viewBox="0 0 75 75" style={this.props.style} >
			 ...
			 <g transform="translate(-36.176 119.69)">
			  <path d="m109.46 141.58a34.207 35.152 0 0 1 -34.204 35.152 34.207 35.152 0 0 1 -34.209 -35.147 34.207 35.152 0 0 1 34.199 -35.157 34.207 35.152 0 0 1 34.214 35.141l-34.207 0.0105z" fill="#12a2d8" stroke="#12a2d8" stroke-width=".065"/>
			  <g>
			   <path d="m43.699 127.28s5.6127-12.027 17.373-17.773l28.731 28.598s-11.893 3.7418-17.64 17.373c0.13363 0-28.464-28.197-28.464-28.197z" fill="#2d2d2d" opacity=".98" stroke="#2c2f30" stroke-width=".065"/>
